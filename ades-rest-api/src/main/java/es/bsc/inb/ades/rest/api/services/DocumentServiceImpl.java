...
public class DocumentServiceImpl implements DocumentService {
	...
	private Object[] addColorToAnnotation2(Object[] data, String className, Annotation annotation) {
		...
		String end_ = "<div class=\"agenttip_finding\"  id=\"hoverShow"+annotation.getStartOffset()+annotation.getEndOffset()+"\" onmouseout=\"this.style.display='none'\">"+annotation.generateHTMLFeatures()+"</div>" + 
				"</span>";
